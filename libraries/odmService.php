...
/**
 * @file
 * TMS Services for the GovDelivery Integration module.
 */
 ...
 */
class TMSCredentials extends XMLData {
  public $realm = 'TMS';
  public $username;
  public $password;
 ...
 * TMS message.
 */
class TMSMessage extends XMLData {
  public $body;
 ...
 * Delivery activity.
 */
class TMSDeliveryActivitySince extends XMLData {
  public $maxresults;
  public $sequence = '';
...
class OdmService extends SoapClient {
  public $serverUri = 'http://tms.govdelivery.com/TMSv2';

  protected static $classmap = array(
    'credentials' => 'TMSCredentials',
    'message' => 'TMSMessage',
    'deliveryActivitySince' => 'TMSDeliveryActivitySince',
  );
   ...
   * @param string $wsdl
   *   WDSL data.
   * @param TMSCredentials $credentials
   *   Credentials.
   * @param array $options
   *   Options.
   */
  public function __construct($wsdl, TMSCredentials $credentials, $options = array()) {
   ...
   *   Credentials.
   */
  protected function setCredentialsHeader(TMSCredentials $credentials) {
   ...
   *
   * @param TMSMessage $message
   *   The message.
   *
   * @return int
   *   Returns string on success and null or SoapFault exception on failure.
   */
  public function sendMessage(TMSMessage $message) {
   ...
   *
   * @param TMSDeliveryActivitySince $delivery_activity_since
   *   Activity data.
   */
  public function deliveryActivitySince(TMSDeliveryActivitySince $delivery_activity_since) {
    $result = parent::deliveryActivitySince($delivery_activity_since);

    /* $handle = fopen('/tmp/govd_tmsv2.tmp', 'a+');
